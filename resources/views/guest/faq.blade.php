...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#f4f8ff] text-black flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <main class="flex flex-1 items-center w-full px-4 flex-col mt-24">
            <h1 class="text-5xl font-extrabold font-montserrat text-[#1a8dc3] mb-6">Frequently Asked Questions</h1>

            <div class="bg-white rounded-xl shadow-xl max-w-5xl w-full flex flex-col py-16 px-8 relative overflow-hidden">


                <div class="bg-[#f4f8ff] shadow-md rounded-lg p-6 max-w-3xl mx-auto">
                <ol class="list-decimal list-inside space-y-4 text-gray-700">
                    <li><span class="font-bold">How do I place an order?</span> — Simply browse our shop, add items to your cart, and proceed to checkout.</li>
                    <li><span class="font-bold">What payment methods are accepted?</span> — We accept credit cards, debit cards, and e-wallets.</li>
                    <li><span class="font-bold">Do you offer shipping?</span> — Yes, nationwide shipping is available within the Philippines.</li>
                    <li><span class="font-bold">Can I return an item?</span> — Returns are accepted within 7 days if the jewelry is unused and in original packaging.</li>
                </ol>
                </div>
            </div>
        </main>
